<template>
    <div class="article-admin">
        <b-form>
                ...
                <b-col xs="12">
                    <b-form-group label="Descrição:" label-for="article-description">
                        <b-form-input id="article-description" type="text" v-model="article.description" required
                            :readonly="mode === 'remove'" placeholder="Informe a Descrição do Artigo.." />
                    </b-form-group>
                </b-col>
            </b-row>
            <b-row>
            ...
            <b-row>
                <b-col xs="12">
                    <b-form-group v-if="mode === 'save'" label="Autor:" label-for="article-users">
                        <b-form-select id="article-users" :options="users" v-model="article.userId" />
                    </b-form-group>
                </b-col>
            </b-row>
            <b-row>
